...
function openMenu() {
  ...
  var windowWidth =
    $window.width() > 1440 && $isfirefox == 0 ? 1440 : $window.width();
        ...
        $(this)
          ...
          .each(function () {
            ...
            if ($window.width() < 992) {
              ...
              $(".menu > li a.active").attr("href") == $first ||
              $(this).attr("href") == $last
            ) {
              $(this).addClass("active");
              var $id = $(this).attr("href");
        ...
        $(this)
          ...
          .each(function () {
            ...
            if ($window.width() < 992) {
              ...
              $(".menu > li a.active").attr("href") == $last ||
              $(this).attr("href") == $first
            ) {
              $(this).addClass("active");
              var $id = $(this).attr("href");
